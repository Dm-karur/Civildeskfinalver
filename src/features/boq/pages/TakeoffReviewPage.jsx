...
const DEFAULT_REVIEWS = [

  {
    ...
    status: 'Verified',
    audit_notes: 'All deduction volumes for lift shafts and sump pits independently cross-checked against rev R2 drawings. Quantities certified 100% accurate.'
  },
  {
    id: 2,
    project_id: 1,
    ...
    status: 'Verified',
    audit_notes: 'Verified beam-column junction deductions. Meets IS 1200 method of measurement.'
  },
  {
    id: 3,
    project_id: 1,
    ...
    measured_quantity: 2726.4,
    verified_quantity: 2540.0,
    uom_name: 'Sq.M',
    variance_pct: -6.8,
    measured_by: 'P. Vignesh (QS Assistant)',
    auditor_name: 'Er. V. Murugan (Architectural Auditor)',
    audit_date: '2026-08-12',
    status: 'Discrepancy Flagged',
    audit_notes: 'Deduction for aluminum curtain wall openings on North elevation was omitted in initial sheet. Quantity adjusted from 2,726.40 Sq.M to 2,540.00 Sq.M.'
  },
  {
    id: 4,
    project_id: 2,
