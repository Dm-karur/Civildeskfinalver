...
const DEFAULT_TAKEOFFS = [
  {
    ...
    drawing_category_name: 'Structural Framing & Foundation (STR)',
    drawing_ref_no: 'DWG-STR-FND-002 Rev-R2',
    takeoff_code: 'QTO-FND-001',
    title: 'Raft Foundation Concrete Volume Takeoff (Grid A1-D6)',
    location_name: 'Basement 2 Raft Pour Area',
    uom_name: 'Cu.M',
    multiplier: 1,
    length_m: 48.5,
    breadth_m: 24.0,
    depth_m: 1.25,
    calculated_quantity: 1455.0,
    status: 'Verified',
    measured_by: 'Arun Prakash (Senior QS)',
    verified_by: 'Lead Structural Auditor',
    formula_display: '1 × 48.50m × 24.00m × 1.25m = 1,455.00 Cu.M',
    notes: 'M40 grade RMC raft concrete including sump pit deductions and lift core deepening.'
  },
  {
    id: 2,
    project_id: 1,
    ...
    title: 'Ground to Level 4 Peripheral RC Columns Concrete & Shuttering',
    location_name: 'Podium Levels 1 to 4',
    uom_name: 'Cu.M',
    multiplier: 24,
    length_m: 0.9,
    breadth_m: 0.6,
    depth_m: 3.6,
    calculated_quantity: 46.66,
    status: 'Verified',
    measured_by: 'K. Senthil (Estimator)',
    verified_by: 'Lead Structural Auditor',
    formula_display: '24 cols × 0.90m × 0.60m × 3.60m = 46.66 Cu.M',
    notes: 'M50 high strength concrete for 24 nos. rectangular column sections.'
  },
  {
    id: 3,
    project_id: 1,
    project_code: 'PRJ-2026-001',
    project_name: 'Metro Commercial Tower Block A',
    drawing_category_id: 'architectural',
    drawing_category_name: 'Architectural Plans & Masonry (ARC)',
    ...
    location_name: 'Floors 4 through 10',
    uom_name: 'Sq.M',
    multiplier: 6,
    length_m: 142.0,
    breadth_m: 1.0,
    depth_m: 3.2,
    calculated_quantity: 2726.4,
    status: 'In Progress',
    measured_by: 'P. Vignesh (QS Assistant)',
    verified_by: '—',
    formula_display: '6 floors × 142.00m × 3.20m ht (less 25% doors/windows) = 2,726.40 Sq.M',
    notes: '200mm AAC blocks with thin bed joint adhesive mortar.'
  },
  {
    id: 4,
    project_id: 2,
    ...
    drawing_category_id: 'highway',
    drawing_category_name: 'Road Alignment & Cross Sections (HWY)',
    ...
    location_name: 'Section KM 12+000 to KM 18+500',
    uom_name: 'Cu.M',
    multiplier: 2,
    length_m: 6500.0,
    breadth_m: 10.5,
    depth_m: 0.075,
    calculated_quantity: 10237.5,
    status: 'Verified',
    measured_by: 'Anand Kumar (Highway QS)',
    verified_by: 'Resident Engineer',
    formula_display: '2 dual carriageways × 6,500m × 10.50m × 0.075m = 10,237.50 Cu.M',
