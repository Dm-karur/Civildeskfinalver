...
const DEFAULT_ACTIVITIES = [

  {
    ...
    is_critical: false,
    predecessor: 'Start',
    assigned_to: 'Apex Earthmovers Pvt Ltd',
    status: 'Completed'
  },
  {
    id: 2,
    ...
    progress_pct: 90,
    is_critical: true,
    predecessor: 'ACT-0101-EXC (FS)',
    assigned_to: 'Arun Prakash (Senior PM)',
    status: 'In Progress'
  },
  {
    id: 3,
    ...
    progress_pct: 35,
    is_critical: true,
    predecessor: 'ACT-0102-RAFT (FS)',
    assigned_to: 'K. Senthil (Site Incharge)',
    status: 'In Progress'
  },
  {
    id: 4,
    ...
    progress_pct: 10,
    is_critical: false,
    predecessor: 'ACT-0102-RAFT (SS+15d)',
    assigned_to: 'Sterling MEP Contractors',
    status: 'In Progress'
  },
  {
    id: 5,
    ...
    project_code: 'PRJ-2026-001',
    project_name: 'Metro Commercial Tower Block A',
    activity_code: 'ACT-0401-AAC',
    name: 'Internal Office AAC Block Masonry Walls',
    phase_id: 'finishes',
    phase_name: 'Architectural & Finishes',
    zone_name: 'Levels 4 to 12',
    start_date: '2026-11-01',
    end_date: '2026-12-31',
    duration_days: 60,
    progress_pct: 0,
    is_critical: false,
    predecessor: 'ACT-0201-COL (FS+10d)',
    assigned_to: 'Civil Craft Subcontractor',
    status: 'Not Started'
  },
];
*/
