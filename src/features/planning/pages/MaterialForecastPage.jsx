...
const DEFAULT_FORECASTS = [
  {
    ...
    name: 'Fe550D TMT Reinforcement Steel Rebar (8mm-32mm)',
    ...
    m3_qty: 55.0,
    total_qty: 170.0,
    total_amount: 10965000,
    delivery_plan: 'Staggered weekly trailers from primary mill stockyard (22 MT per lot).',
  },
  {
    id: 2,
    project_id: 1,
    project_code: 'PRJ-2026-001',
    project_name: 'Metro Commercial Tower Block A',
    material_code: 'MAT-RMC-M40',
    name: 'Design Mix Ready Mixed Concrete (RMC) M40 Grade',
    ...
    m3_qty: 740.0,
    total_qty: 2210.0,
    total_amount: 12265500,
    delivery_plan: 'Transit mixer fleet from nearby commercial batching plant (8 Cu.M drum capacity).',
  },
  {
    id: 3,
    project_id: 1,
    ...
    delivery_plan: 'Palletized packaging with shrink-wrap delivery directly to crane hoisting zone.',
  },
  {
    id: 4,
    project_id: 2,
