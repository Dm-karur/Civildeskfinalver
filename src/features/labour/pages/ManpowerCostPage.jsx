...
const DEFAULT_MANPOWER_COSTS = [

  {
    ...
    wbs_code: 'WBS-1.2',
    trade_name: 'RCC Column & Core Wall Concrete Pouring',
    ...
    actual_cost: 138500,
    variance_amount: 11500,
    variance_pct: 7.6,
    unit_rate_actual: 432.8,
    unit_rate_budget: 468.7,
    status: 'Under Budget',
    notes: 'Tower A Level 2 column pours completed with high pump efficiency.'
  },
  {
    id: 2,
    project_id: 1,
    ...
    project_name: 'Metro Commercial Tower Block A',
    wbs_code: 'WBS-1.4',
    trade_name: 'Level 2 Peripheral Brick Masonry & Partition Walls',
    category_name: 'Masonry & Plastering Gang',
    contractor_name: 'Sri Murugan Labour Services',
    mandays_spent: 98,
    regular_hours: 784,
    ot_hours: 32,
    ...
    variance_pct: 2.0,
    unit_rate_actual: 36.0,
    unit_rate_budget: 36.7,
    status: 'On Track',
    notes: 'AAC block masonry executed as per drawing schedule.'
  },
  {
    id: 3,
    project_id: 1,
    ...
    project_name: 'Metro Commercial Tower Block A',
    wbs_code: 'WBS-2.1',
    trade_name: 'Basement 2 Sump Dewatering & Housekeeping',
    category_name: 'Site General Utility Crew',
    ...
    variance_pct: -10.6,
    unit_rate_actual: 49800,
    unit_rate_budget: 45000,
    status: 'Over Budget',
    notes: 'Continuous dewatering required due to unforeseen subsoil water table rise.'
  },
  {
    id: 4,
    project_id: 2,
    ...
    wbs_code: 'WBS-3.2',
    trade_name: 'Box Culvert Rebar Fabrication & Tying',
    category_name: 'Steel Barbending Gang',
    ...
    output_qty: 28.5,
    uom: 'MT',
    budgeted_cost: 165000,
    actual_cost: 154200,
    variance_amount: 10800,
    variance_pct: 6.5,
    unit_rate_actual: 5410.5,
    unit_rate_budget: 5789.4,
    status: 'Under Budget',
