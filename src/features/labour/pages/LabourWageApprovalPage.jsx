...
const DEFAULT_WAGE_BATCHES = [

  {
    ...
    batch_code: 'WB-2026-W34',
    period_start: '2026-08-17',
    period_end: '2026-08-23',
    period_label: 'Week 34 (17 Aug - 23 Aug 2026)',
    contractor_name: 'Sri Murugan Labour Services',
    worker_count: 24,
    total_mandays: 144,
    total_ot_hours: 48,
    gross_wages: 138500,
    advances_deducted: 12400,
    net_payable: 126100,
    status: 'Pending PM Approval',
    current_approver: 'Er. Suresh Babu (Project Director)',
    prepared_by: 'Er. Rajesh Kumar (Site Incharge)',
    notes: 'Includes Level 2 column casting extended shift OT hours.'
  },
  {
    id: 2,
    project_id: 1,
    ...
    total_ot_hours: 12,
    gross_wages: 42000,
    advances_deducted: 2500,
    net_payable: 39500,
    status: 'Approved & Released',
    current_approver: 'Finance Accounts Team',
    prepared_by: 'S. Natesan (General Foreman)',
    notes: 'Basement maintenance and dewatering team weekly muster.'
  },
  {
    id: 3,
    project_id: 2,
    ...
    total_ot_hours: 64,
    gross_wages: 122400,
    advances_deducted: 9800,
    net_payable: 112600,
    status: 'Approved & Released',
    current_approver: 'K. Balaji (Highway PM)',
    prepared_by: 'K. Balaji',
    notes: 'Culvert rebar cutting and haunch reinforcement wage sheet.'
  },
  {
    id: 4,
    project_id: 1,
    project_code: 'PRJ-2026-001',
    project_name: 'Metro Commercial Tower Block A',
    batch_code: 'WB-2026-W33',
    period_start: '2026-08-10',
    period_end: '2026-08-16',
    period_label: 'Week 33 (10 Aug - 16 Aug 2026)',
    contractor_name: 'Sri Murugan Labour Services',
    worker_count: 22,
    total_mandays: 132,
    total_ot_hours: 38,
    gross_wages: 124800,
    advances_deducted: 11000,
    net_payable: 113800,
    status: 'Approved & Released',
    current_approver: 'Finance Accounts Team',
    prepared_by: 'Er. Rajesh Kumar (Site Incharge)',
