...
const DEFAULT_EXCEPTIONS = [

  {
    ...
    exception_id: 'missing_punch',
    recorded_in: '08:00 AM',
    recorded_out: '— (No Punch)',
    adjusted_in: '08:00 AM',
    adjusted_out: '06:00 PM',
    hours_credited: 8.0,
    ot_credited: 1.0,
    status: 'Pending Approval',
    supervisor_name: 'Er. Rajesh Kumar',
    reason: 'Worker stayed back for Level 2 column top shuttering alignment and missed biometric punch.'
  },
  {
    id: 2,
    project_id: 1,
    ...
    incident_date: '2026-08-20',
    shift_name: 'General Day Shift',
    exception_type: 'Late Arrival (> 30 mins)',
    exception_id: 'late_arrival',
    recorded_in: '08:50 AM (+50m)',
    recorded_out: '05:00 PM',
    adjusted_in: '08:00 AM',
    ...
    status: 'Regularized',
    supervisor_name: 'Er. Rajesh Kumar',
    reason: 'Local transit bus breakdown. Worked 30 mins during lunch break to compensate.'
  },
  {
    id: 3,
    project_id: 1,
    ...
    shift_name: 'General Day Shift',
    exception_type: 'Continuous Absence Streak',
    exception_id: 'absent_streak',
    recorded_in: '—',
    recorded_out: '—',
    adjusted_in: '—',
    adjusted_out: '—',
    ...
    reason: '3 consecutive days absent without contractor intimation. Muster hold applied.'
  },
  {
    id: 4,
    project_id: 2,
    ...
    exception_type: 'Overtime Hours Discrepancy',
    exception_id: 'ot_dispute',
    recorded_in: '08:00 PM',
    recorded_out: '07:30 AM',
    adjusted_in: '08:00 PM',
    adjusted_out: '07:00 AM',
    hours_credited: 8.0,
    ot_credited: 3.0,
    status: 'Regularized',
