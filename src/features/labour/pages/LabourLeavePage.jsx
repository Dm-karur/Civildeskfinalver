...
const DEFAULT_LEAVE_APPLICATIONS = [
  {
    ...
    end_date: '2026-08-28',
    total_days: 4,
    replacement_worker: 'M. Durai (Mason)',
    reason: 'Village temple festival participation. Gang lead arranged substitute mason.',
    status: 'Approved',
    approved_by: 'Er. Rajesh Kumar'
  },
  {
    id: 2,
    project_id: 1,
    ...
    end_date: '2026-08-22',
    total_days: 2,
    replacement_worker: 'Direct Squad Pool',
    reason: 'Fever and viral cold. Camp medical checkup conducted.',
    status: 'Approved',
    approved_by: 'Er. Rajesh Kumar'
  },
  {
    ...
    project_code: 'PRJ-2026-001',
    project_name: 'Metro Commercial Tower Block A',
    leave_code: 'LV-2026-043',
    worker_id: 4,
    worker_code: 'LAB-0003',
    worker_name: 'S. Kavitha',
    category_name: 'General Helper',
    contractor_name: 'Direct Company Roll',
    leave_type: 'Casual Personal Leave',
    start_date: '2026-08-24',
    end_date: '2026-08-24',
    total_days: 1,
    replacement_worker: '—',
    reason: 'Bank work and Aadhaar KYC renewal in town.',
    status: 'Pending Review',
    approved_by: 'S. Natesan'
  },
  {
    id: 4,
    project_id: 2,
    ...
    end_date: '2026-08-29',
    total_days: 4,
    replacement_worker: 'Gang Rebar Benders Pool',
    reason: 'Family emergency travel to hometown.',
    status: 'Approved',
