...
const DEFAULT_WAGE_RECORDS = [
  ...
  },
  {
    ...
    account_masked: 'XXXX-XXXX-1934',
    base_rate_per_day: 780,
    present_days: 6.0,
    ot_hours: 4.0,
    reg_earnings: 4680,
    ot_earnings: 390,
    ...
    canteen_deducted: 120,
    net_payable: 4650,
    payment_mode: 'Bank Transfer (NEFT)',
    status: 'Approved for Payout',
    settlement_date: '2026-08-24',
    notes: 'Material handling and mixer batching.'
  },
  {
    id: 3,
    project_id: 1,
    ...
    account_masked: 'XXXX-XXXX-8821',
    base_rate_per_day: 750,
    present_days: 6.0,
    ot_hours: 0.0,
    reg_earnings: 4500,
    ot_earnings: 0,
    ...
    canteen_deducted: 0,
    net_payable: 4500,
    payment_mode: 'UPI / Direct Roll',
    status: 'Paid / Settled',
    settlement_date: '2026-08-23',
    notes: 'Basement dewatering and site housekeeping.'
  },
  {
    id: 4,
    project_id: 2,
    ...
    bank_name: 'HDFC Bank',
    account_masked: 'XXXX-XXXX-6102',
    base_rate_per_day: 1200,
    present_days: 6.0,
    ot_hours: 8.0,
    reg_earnings: 7200,
    ot_earnings: 1200,
