...
const DEFAULT_STATEMENT_ENTRIES = [
  {
    ...
    txn_type: 'Advance Invoice',
    reference_no: 'ADV-2026-001',
    description: 'Mobilization Advance Claim (10% with ABG)',
    debit_billed: 28500000,
    credit_received: 0,
    running_balance: 28500000
  },
  {
    id: 2,
    project_id: 1,
    ...
    txn_type: 'Bank Remittance',
    reference_no: 'RCT-2026-012',
    description: 'Mobilization Advance received via HDFC RTGS',
    debit_billed: 0,
    credit_received: 28500000,
    running_balance: 0
  },
  {
    id: 3,
    ...
    txn_type: 'Tax Invoice',
    reference_no: 'INV-2026-020',
    description: 'RA Progress Bill 1 (Basement & Substructure)',
    debit_billed: 13500000,
    credit_received: 0,
    running_balance: 13500000
  },
  {
    id: 4,
    project_id: 1,
    ...
    txn_type: 'Bank Remittance',
    reference_no: 'RCT-2026-024',
    description: 'Payment against RA 1 (Net of Retention & Advance)',
    debit_billed: 0,
    credit_received: 13500000,
    running_balance: 0
  },
  {
    id: 5,
    ...
    txn_type: 'Tax Invoice',
    reference_no: 'INV-2026-042',
    description: 'RA Progress Bill 3 (Level 2 & 3 RCC Columns)',
    debit_billed: 16756000,
    credit_received: 0,
    running_balance: 16756000
  },
  {
    id: 6,
    project_id: 1,
    ...
    txn_type: 'Bank Remittance',
    reference_no: 'RCT-2026-042',
    description: 'Payment against RA Bill 3 via RTGS',
    debit_billed: 0,
    credit_received: 15762000,
