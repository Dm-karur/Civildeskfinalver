...
const DEFAULT_INSTRUCTIONS = [

  {
    ...
    location_name: 'Raft Foundation Grid B3-D5',
    instruction_code: 'SI-2026-001',
    subject: 'Additional Reinforcement Bar Chipping & Clear Cover Rectification',
    category_id: 'structural',
    category_name: 'Structural & Concrete Execution',
    priority: 'Critical',
    issued_by: 'Karthik Raja (Chief Structural Consultant)',
    issued_to: 'Apex Civil Contractors Pvt Ltd',
    issue_date: '2026-06-12',
    due_date: '2026-06-15',
    status: 'Complied & Verified',
    directive_text: 'Ensure minimum 75mm clear cover blocks installed beneath raft bottom reinforcement mesh prior to final pour clearance.',
    compliance_notes: 'Verified on-site by Site Engineer. Cover blocks placed at 1m grid intervals. Pour clearance endorsed.'
  },
  {
    id: 2,
    project_id: 1,
    ...
    site_id: 1,
    site_name: 'Tower A Main Construction Plot',
    location_name: 'Podium Level 1 Ramp Area',
    instruction_code: 'SI-2026-002',
    subject: 'Mandatory Double Guardrail Installation on Excavation Edge',
    category_id: 'safety',
    category_name: 'Safety & HSE Corrective Action',
    priority: 'Critical',
    issued_by: 'Suresh Kumar (Site Safety Officer)',
    issued_to: 'All Subcontractors & Earthmoving Crew',
    issue_date: '2026-07-01',
    due_date: '2026-07-02',
    status: 'Complied & Verified',
    directive_text: 'Immediate barricading with 1.1m high double pipe guardrail and retro-reflective warning tape around 4m deep basement pit.',
    compliance_notes: 'Rigid scaffolding pipe edge protection erected. Safety signage displayed.'
  },
  {
    id: 3,
    project_id: 1,
    ...
    site_id: 1,
    site_name: 'Tower A Main Construction Plot',
    location_name: 'Floor Level 4 Core Wall',
    instruction_code: 'SI-2026-003',
    subject: 'Curing Period Extension & Moisture Retention Hessian Cloth Wrapping',
    category_id: 'quality',
    category_name: 'QA/QC Inspection & Snagging',
    priority: 'High',
    issued_by: 'R. Vignesh (Site QA/QC Engineer)',
    issued_to: 'Structural Concreting Gang',
    issue_date: '2026-08-10',
    due_date: '2026-08-20',
    status: 'In Progress',
    directive_text: 'Maintain continuous wet burlap curing on high-strength M50 shear wall columns for minimum 14 days due to ambient high heat.',
    compliance_notes: 'Water sprinkling schedule assigned to night shift supervisor. Daily log active.'
  },
  {
    id: 4,
    project_id: 2,
    ...
    location_name: 'Ch. 15+400 Cross Culvert',
    instruction_code: 'SI-HWY-014',
    subject: 'Sub-base Layer Re-compaction & Field Moisture Correction',
    category_id: 'material',
    category_name: 'Material Rejection / Rework',
    priority: 'Medium',
    issued_by: 'Anand Kumar (Resident Engineer)',
    issued_to: 'National Roadworks Corp',
    issue_date: '2026-08-14',
    due_date: '2026-08-18',
    status: 'Open',
    directive_text: 'Dry density test showed 94.2% Proctor density against 98% required. Scarify top 150mm, add moisture, and re-roll with 10T roller.',
