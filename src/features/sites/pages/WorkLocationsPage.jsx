...
const DEFAULT_LOCATIONS = [

  {
    ...
    location_code: 'LOC-RAFT-P1',
    location_name: 'Raft Foundation Pour 1 (Grid A1-D6)',
    location_type_name: 'Foundation Slab',
    planned_start_date: '2026-06-10',
    planned_end_date: '2026-07-15',
    progress_percentage: 100,
    status_name: 'Completed',
    description: '1,200 cu.m mass concrete pour with temperature sensor monitoring.'
  },
  {
    id: 2,
    project_id: 1,
    ...
    location_code: 'LOC-POD-LVL1',
    location_name: 'Podium Level 1 Parking Deck & Ramps',
    location_type_name: 'Floor Slab & Ramp',
    planned_start_date: '2026-08-10',
    planned_end_date: '2026-10-31',
    progress_percentage: 70,
    status_name: 'In Progress',
    description: 'Beam & slab shuttering, PT cable profiling, and conduit laying.'
  },
  {
    id: 3,
    project_id: 1,
    ...
    location_code: 'LOC-FL04-OFFICE',
    location_name: 'Level 4 Typical Commercial Office Floor Plate',
    location_type_name: 'Superstructure Floor',
    planned_start_date: '2026-10-15',
    planned_end_date: '2026-12-15',
    progress_percentage: 15,
    status_name: 'In Progress',
    description: 'Core shear wall slipforming and peripheral column staging.'
  },
  {
    id: 4,
    project_id: 2,
    ...
    location_code: 'LOC-CULV-14',
    location_name: 'Box Culvert at Ch. 14+250',
    location_type_name: 'Cross Drainage Structure',
