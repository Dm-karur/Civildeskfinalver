...
const DEFAULT_APPROVALS = [

  {
    ...
    revision_tag: 'Baseline v1.0',
    approval_level: 1,
    approval_level_name: 'Level 1: Project Director',
    total_amount: 21625000,
    requested_by: 'Arun Prakash (Senior PM)',
    submitted_at: '2026-06-15 10:30',
    decided_by: 'K. Rajesh (Project Director)',
    decided_at: '2026-06-16 14:20',
    status: 'Approved',
    comments: 'Baseline cost model verified against structural BOQ rates. Recommended for execution.'
  },
  {
    id: 2,
    project_id: 1,
    ...
    budget_code: 'BUD-001',
    budget_name: 'Greenfield Residency Initial Cost Budget',
    revision_tag: 'Rev-2 (Steel Escalation)',
    approval_level: 2,
    approval_level_name: 'Level 2: Commercial & QS Head',
    total_amount: 24650000,
    requested_by: 'K. Senthil (QS Lead)',
    submitted_at: '2026-08-10 11:15',
    decided_by: '—',
    decided_at: '—',
    status: 'Pending Review',
    comments: 'Market quote comparison submitted for 180 MT primary steel requirement.'
  },
  {
    id: 3,
    project_id: 2,
    ...
    revision_tag: 'Rev-1 (Culvert Addition)',
    approval_level: 3,
    approval_level_name: 'Level 3: Executive Managing Director',
    total_amount: 47200000,
    requested_by: 'R. Vignesh (Highway Lead)',
    submitted_at: '2026-08-01 09:45',
    decided_by: 'S. Ramanathan (Managing Director)',
    decided_at: '2026-08-02 16:30',
    status: 'Approved',
    comments: 'Authorized after client signed Variation Order VO-04 confirmation.'
  },
  {
    id: 4,
    project_id: 1,
    ...
    budget_code: 'BUD-001',
    budget_name: 'Greenfield Residency Initial Cost Budget',
    revision_tag: 'Draft Proposal Test',
    approval_level: 1,
    approval_level_name: 'Level 1: Project Director',
    total_amount: 1500000,
    requested_by: 'Junior Estimator',
    submitted_at: '2026-07-28 14:00',
    decided_by: 'K. Rajesh (Project Director)',
    decided_at: '2026-07-29 10:15',
    status: 'Rejected',
